...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FacebookUserExperiment.why_movie_like'
        db.add_column(u'django_facebook_facebookuserexperiment', 'why_movie_like',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FacebookUserExperiment.why_movie_like'
        db.delete_column(u'django_facebook_facebookuserexperiment', 'why_movie_like')
    ...
    models = {
        ...
        u'django_facebook.facebookuserexperiment': {
            ...
            'user_id': ('django.db.models.fields.IntegerField', [], {}),
            'why_movie_like': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'})
        },
