...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        # Adding model 'FacebookUserMovies'
        db.create_table(u'django_facebook_facebookusermovies', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user_id', self.gf('django.db.models.fields.IntegerField')()),
            ('facebook_id', self.gf('django.db.models.fields.BigIntegerField')()),
            ('name', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('category', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('created_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('movie_source', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('movie_about', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'django_facebook', ['FacebookUserMovies'])

        # Adding unique constraint on 'FacebookUserMovies', fields ['user_id', 'facebook_id']
        db.create_unique(u'django_facebook_facebookusermovies', ['user_id', 'facebook_id'])
        ...
        db.create_table(u'django_facebook_facebookprofile', (
            ...
            ('user',
             self.gf('django.db.models.fields.related.OneToOneField')(to=orm['django_facebook.FacebookCustomUser'],
                                                                      unique=True)),
        ))
        ...
        db.create_table('django_facebook_open_graph_share', (
            ...
            ('created_at',
             self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
        ))
        db.send_create_signal(u'django_facebook', ['OpenGraphShare'])


    def backwards(self, orm):
        # Removing unique constraint on 'FacebookUserMovies', fields ['user_id', 'facebook_id']
        db.delete_unique(u'django_facebook_facebookusermovies', ['user_id', 'facebook_id'])
        ...
        # Deleting model 'FacebookUserMovies'
        db.delete_table(u'django_facebook_facebookusermovies')
    ...
    models = {
        ...
        u'django_facebook.facebookcustomuser': {
            ...
            'facebook_id': (
            'django.db.models.fields.BigIntegerField', [], {'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'facebook_name': (
        ...
        u'django_facebook.facebookprofile': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [],
                     {'to': u"orm['django_facebook.FacebookCustomUser']", 'unique': 'True'}),
            'website_url': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'})
        },
        ...
        u'django_facebook.opengraphshare': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [],
                             {'to': u"orm['contenttypes.ContentType']", 'null': 'True', 'blank': 'True'}),
            'created_at': (
            ...
            'user': (
            'django.db.models.fields.related.ForeignKey', [], {'to': u"orm['django_facebook.FacebookCustomUser']"})
        }
    }
