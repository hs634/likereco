...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FacebookUserExperiment'
        db.create_table(u'django_facebook_facebookuserexperiment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user_id', self.gf('django.db.models.fields.IntegerField')()),
            ('facebook_id_first', self.gf('django.db.models.fields.BigIntegerField')()),
            ('facebook_id_second', self.gf('django.db.models.fields.BigIntegerField')()),
            ('user_clicked', self.gf('django.db.models.fields.BigIntegerField')(null=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'django_facebook', ['FacebookUserExperiment'])


    def backwards(self, orm):
        # Deleting model 'FacebookUserExperiment'
        db.delete_table(u'django_facebook_facebookuserexperiment')
    ...
    models = {
        ...
        u'django_facebook.facebookuserexperiment': {
            'Meta': {'object_name': 'FacebookUserExperiment'},
