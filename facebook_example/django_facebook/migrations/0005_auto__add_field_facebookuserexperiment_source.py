...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FacebookUserExperiment.source'
        db.add_column(u'django_facebook_facebookuserexperiment', 'source',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FacebookUserExperiment.source'
        db.delete_column(u'django_facebook_facebookuserexperiment', 'source')
