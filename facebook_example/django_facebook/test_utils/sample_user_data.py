...
user_data['no_email'] = {'first_name': 'Thierry', 'last_name': 'Schellenbach', 'verified': True,
                         'name': 'Thierry Schellenbach', 'gender': 'man',
                         'image': 'http://graph.facebook.com/me/picture?type=large', 'updated_time':
    '2010-04-01T14:26:55+0000', 'birthday': '04/07', 'link': 'http://www.facebook.com/profile.php?id=1225707780',
                         'location': {'id': None, 'name': None}, 'timezone': -5, 'id': '1225707780',
                         'image_thumb': 'http://graph.facebook.com/me/picture'}
user_data[
    'tschellenbach'] = {'email': 'fake@mellowmorning.com', 'first_name': 'Thierry', 'last_name': 'Schellenbach',
                        'verified': True, 'name': 'Thierry Schellenbach', 'gender': 'man',
                        'image': 'http://graph.facebook.com/me/picture?type=large',
                        'updated_time': '2010-04-01T14:26:55+0000', 'birthday': '04/07',
                        'link': 'http://www.facebook.com/profile.php?id=1225707780',
                        'location': {'id': None, 'name': None}, 'timezone': -5, 'id': '1225707780',
                        'image_thumb': 'http://graph.facebook.com/me/picture'}
user_data[
    'new_user'] = {'email': 'fake_new@mellowmorning.com', 'first_name': 'Thierry', 'last_name': 'Schellenbach',
                   'verified': True, 'name': 'Thierry Schellenbach', 'gender': 'male',
                   'image': 'http://graph.facebook.com/me/picture?type=large',
                   'updated_time': '2010-04-01T14:26:55+0000', 'birthday': '04/07',
                   'link': 'http://www.facebook.com/profile.php?id=1225707780', 'location': {'id': None, 'name': None},
                   'timezone': -5, 'id': '1225707781', 'image_thumb': 'http://graph.facebook.com/me/picture'}
user_data[
    'no_birthday'] = {'website': 'www.pytell.com', 'first_name': 'Jonathan', 'last_name': 'Pytell', 'verified': True,
                      'name': 'Jonathan Pytell', 'image': 'http://graph.facebook.com/me/picture?type=large',
                      'updated_time': '2010-01-01T18:13:17+0000', 'link': 'http://www.facebook.com/jpytell',
                      'location': {'id': None, 'name': None}, 'timezone': -4, 'id': '776872663',
                      'image_thumb': 'http://graph.facebook.com/me/picture'}
user_data['partial_birthday'] = {'first_name': 'Thierry', 'last_name': 'Schellenbach', 'verified': True,
                                 'name': 'Thierry Schellenbach', 'gender': 'man',
                                 'image': 'http://graph.facebook.com/me/picture?type=large', 'updated_time':
    '2010-04-01T14:26:55+0000', 'birthday': '04/07', 'link': 'http://www.facebook.com/profile.php?id=1225707780',
                                 'location': {'id': None, 'name': None}, 'timezone': -5, 'id': '1225707780',
                                 'image_thumb': 'http://graph.facebook.com/me/picture'}
user_data[
    'short_username'] = {'email': 'f@mellowmorning.com', 'first_name': 'Thierry', 'last_name': 'Schellenbach',
                         'verified': True, 'name': 'Thierry Schellenbach', 'gender': 'man',
                         'image': 'http://graph.facebook.com/me/picture?type=large',
                         'updated_time': '2010-04-01T14:26:55+0000', 'birthday': '04/07',
                         'link': 'http://www.facebook.com/profile.php?id=1225707780',
                         'location': {'id': None, 'name': None}, 'timezone': -5, 'id': '1225707782',
                         'image_thumb': 'http://graph.facebook.com/me/picture'}
user_data[
    'long_username'] = {'email': 'superduperlongusernamemorethan30characters@mellowmorning.com',
                        'first_name': 'Thierry123456789123456789123456789123456789123456789123456789123456789123456789123456789',
                        'last_name': 'Schellenbach123456789123456789123456789123456789123456789123456789',
                        'verified': True, 'name': 'Thierry Schellenbach',
                        'gender': 'man', 'image': 'http://graph.facebook.com/me/picture?type=large',
                        'updated_time': '2010-04-01T14:26:55+0000', 'birthday': '04/07',
                        'link': 'http://www.facebook.com/profile.php?id=1225707780',
                        'location': {'id': None, 'name': None}, 'timezone': -5, 'id': '1225707782',
                        'image_thumb': 'http://graph.facebook.com/me/picture'}
...
user_data['paul'] = {"website": "http://usabilla.com", "last_name": "Veugen", "locale": "en_US",
                     "image": "https://graph.facebook.com/me/picture?access_token=aa&type=large",
                     "quotes": "\"Make no small plans for they have no power to stir the soul.\"  - Machiavelli",
                     "timezone": 1, "education": [
    {"school": {"id": "114174235260224", "name": "Tilburg University"}, "type": "College",
     "year": {"id": "136328419721520", "name": "2009"}},
    {"school": {"id": "111600322189438", "name": "Tilburg University"}, "type": "Graduate School",
     "concentration": [{"id": "187998924566551", "name": "Business Communication and Digital Media"},
                       {"id": "105587479474873", "name": "Entrepreneurship"}],
     "degree": {"id": "110198449002528", "name": "BA"}}], "id": "555227728", "first_name": "Paul", "verified": True,
                     "sports": [{"id": "114031331940797", "name": "Cycling"},
                                {"id": "107496599279538", "name": "Snowboarding"},
                                {"id": "109368782422374", "name": "Running"}],
                     "languages": [{"id": "106059522759137", "name": "English"},
                                   {"id": "107672419256005", "name": "Dutch"}], "location": {
    "id": "111777152182368", "name": "Amsterdam, Netherlands"},
                     "image_thumb": "https://graph.facebook.com/me/picture?access_token=aa", "email": "paulv@email.com",
                     "username": "pveugen",
                     "bio": "Founder Usabilla. User Experience designer, entrepeneur and digital media addict. On a mission to make user experience research simple and fun with Usabilla.com.",
                     "birthday": "07/11/1984", "link": "http://www.facebook.com/pveugen", "name": "Paul Veugen",
                     "gender": "male", "work": [
    {"description": "http://usabilla.com", "employer": {"id": "235754672838", "name": "Usabilla"},
     "location": {"id": "111777152182368", "name": "Amsterdam, Netherlands"},
     "position": {"id": "130899310279007", "name": "Founder, CEO"},
     "with": [{"id": "1349358449", "name": "Marc van Agteren"}], "start_date": "2009-01"},
    {"position": {"id": "143357809027330", "name": "Communication Designer"}, "start_date": "2000-02",
     "location": {"id": "112258135452858", "name": "Venray"}, "end_date": "2010-01",
     "employer": {"id": "133305113393672", "name": "Flyers Internet Communicatie"}}],
                     "updated_time": "2011-11-27T14:34:34+0000"}

user_data['paul2'] = user_data['paul']
user_data[
    'unicode_string'] = {
u'bio': u'ATELIER : TODOS LOS DIAS DE 14 A 22 HS C CITA PREVIA. MIX DE ESTETICAS - ECLECTICA - PRENDAS UNICAS-HAND MADE- SEASSON LESS RETROMODERNIDAD -CUSTOMIZADO !!!\r\n\r\nMe encanta todo el proceso que lleva lograr un objeto que sea unico....personalizarlo de acuerdo a cada uno...a cada persona....a su forma de ser.......elegir los materiales, los avios, las telas...siendo la premisa DIFERENCIARSE!!!!\r\n Atemporal..Retro modernidad...Eclecticismo!!!',
...
u'work': [{
          u'description': u'ATELIER : un mix de esteticas que la hacen eclectica, multicultural, excentrica, customizada, artesanal, unica , exclusiva, lujosa, eco-reciclada,con bordados a mano y texturas..especial atencion a los peque\xf1os detalles!!!! \nSeason less \nHand made ',
          ...
          u'projects': [{
                        u'description': u'produccion-estilismo-fotografia-make up-pelo-asesoramiento de imagen-whadrobing-perso\xf1an shooper-rent an outfit!!',
                        u'id': u'200218353804',
