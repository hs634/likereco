...
urlpatterns = patterns(
    ...
    #url(r'^survey/$', 'survey', name='facebook_example'),
    url(r'^survey/$', 'survey1', name='facebook_survey'),
    url(r'^survey2/$', 'google_doc_survey', name='facebook_survey1'),
    url(r'^survey3/$', 'survey3', name='facebook_survey3'),
)
